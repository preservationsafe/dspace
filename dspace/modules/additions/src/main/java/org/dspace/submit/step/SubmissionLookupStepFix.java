 ...
 * @version $Revision$
 */
public class SubmissionLookupStepFix extends AbstractProcessingStep
{
    /** log4j logger */
    private static Logger log = Logger.getLogger(SubmissionLookupStepFix.class);
    ...
    /** Constructor */
    public SubmissionLookupStepFix() throws ServletException
    {
