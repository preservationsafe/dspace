 ...
 * @version $Revision$
 */
public class JSPSubmissionLookupStepFix extends JSPStep
{
    /** JSP which displays HTML for this Class * */
    private static final String DISPLAY_JSP = "/submit/lookup-submission.jsp";
    ...
    /** Constructor */
    public JSPSubmissionLookupStepFix() throws ServletException
    {
