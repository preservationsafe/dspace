...
public abstract class AbstractBrowserServlet extends DSpaceServlet
{
            ...
            throws ServletException, IOException, SQLException, AuthorizeException
    {
        try
        {
            ...
            {
                if (StringUtils.isNotBlank(endsDate))
                {
                    startsWith = startsDate + "TO" + endsDate;
                }
                else
                {
                    Date date = new Date();
                    endsDate = new SimpleDateFormat("yyyy-MM-dd").format(date);
                    startsWith = startsDate + "TO" + endsDate;
                }
                //startsWith = startsWith.replace("-", "");
            }

            if (StringUtils.isBlank(startsWith) && StringUtils.isNotBlank(endsDate))
            {
                Date date = new Date(Long.MIN_VALUE);
                startsDate = new SimpleDateFormat("yyyy-MM-dd").format(date);
                startsWith = startsDate + "TO" + endsDate;
            }
            ...
            String arguments = "type=" + type + ",order=" + order + ",value=" + value +
                    ",month=" + month + ",year=" + year + "'starts_date=" + startsDate + "'ends_date=" + endsDate + ",starts_with=" + startsWith +
